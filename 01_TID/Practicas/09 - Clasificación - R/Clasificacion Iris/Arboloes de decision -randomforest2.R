#Ejemplo de arboles de decision con randomForest
...
entrena=iris[ind==1,]
test=iris[ind==2,]
#Seleccionar la libreria randomForest
...
iris_arbol=randomForest(modelo,data=entrena)
table(predict(iris_arbol),entrena$Species)
iris_arbol
#No se dibuja ning?n arbol porque se obitnene muchos de ellos aleatoriamente
