...
import mio.jersey.segundo.maven.modelo.CamisetaDao;
...
public class CamisetaApi {
	...
	// Obtener camiseta buscando por id usuario ////////////////////////////
	@GET
	@Produces({MediaType.APPLICATION_JSON })
	@Path("usuario/{id}")
	public List<Camiseta> obtenerCamisetIdUsuario(@PathParam("id") String id) {
		return CamisetaDao.INSTANCE.obtenerCamisetasPorUsuario(id);
	}
	////////////////////////////////////////////////////////////////////
