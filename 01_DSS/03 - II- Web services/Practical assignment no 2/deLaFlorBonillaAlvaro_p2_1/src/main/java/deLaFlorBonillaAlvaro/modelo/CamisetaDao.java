...
public enum CamisetaDao {
	...
	public Boolean anadirCamiseta(Camiseta camiseta) {
		...
		Camiseta aux = CamisetaRepositorio.obtenerCamisetaPorID(camiseta.getId());
		if (aux == null) {
			res = CamisetaRepositorio.anadirCamisetaNavegador(camiseta.getId(), camiseta.getModelo(), camiseta.getPrecio(), camiseta.getTalla(), camiseta.getVendida(), camiseta.getImage()) != null ? true : false;
		} else {
			res = false;
		}
		return res;
