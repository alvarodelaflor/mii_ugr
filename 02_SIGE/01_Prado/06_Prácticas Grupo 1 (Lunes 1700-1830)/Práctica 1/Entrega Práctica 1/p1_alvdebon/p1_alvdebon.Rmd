...
En esta sección en primer lugar trataremos los valores pérdidos, para ello hemos decido utilizr el valor 39% como máximo (siguiendo las recomendaciones de alguno de los foros que hemos visitado).

Por otro lado también aprovecharemos para eliminar aquellas variables cuyos valores presentan más del 80% de valores distintos, ya que realmente no aportan información útil para nuestro sistema.
